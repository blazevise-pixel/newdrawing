...
env.Drawing=DrawingLib
env.isrenderobj=function(o) local s,r=pcall(function() return o.__type=="Drawing Object" end) return s and r end
env.cleardrawcache=function() if drawingUI then drawingUI:ClearAllChildren() end end
env.getrenderproperty=function(o,p) assert(getgenv().isrenderobj(o),"Object must be a Drawing") return o[p] end
env.setrenderproperty=function(o,p,v) assert(getgenv().isrenderobj(o),"Object must be a Drawing") o[p]=v end
